/* =====================================================
   ui.js — Funzioni di rendering HTML per Dashboard,
   Portafoglio e Impostazioni.

   Nota: renderAccounts() e renderTransactions() sono definite
   in ui-accounts-transactions.js (versione Fase 5 con modello
   dati corrente). Qui non vengono ridefinite per evitare
   sovrascritture incrociate.
   ===================================================== */
...
/* ===== HELPER: riga transazione (per dashboard "movimenti recenti") ===== */
...
function glBlockHTML() {
  ...
  const barW = pC > 0 ? Math.min(Math.max((pV / pC - 1) * 200 + 40, 0), 100) : 0;
  return `
    <div class="card">
...
function renderSettings() {
  ...
  /* === Quotazioni: Worker URL + auto-refresh === */
