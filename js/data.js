/* =====================================================
   ...
   APP_DATA è dinamico: viene caricato da Drive (Fase 3+)
   e modificabile dall'utente (Fase 4+)
   ===================================================== */

/* ===== DATI INIZIALI (mock — sovrascritti da Drive al login) ===== */
let APP_DATA = {
...
const CAT_COLORS = {
  ...
  util:  '#888780', car: '#7F77DD', div:   '#2E7D32',
  shop:  '#D85A30',
};
...
/* ===== VALORI DERIVATI (ricalcolati da recalculate()) ===== */
...
/* ===== AGGIORNA APP_DATA (chiamato dopo caricamento da Drive) ===== */
function setAppData(newData) {
  if (!newData || typeof newData !== 'object') return;
  // Merge selettivo per non perdere campi non noti
...
/* Calcolo iniziale con dati mock */
recalculate();
